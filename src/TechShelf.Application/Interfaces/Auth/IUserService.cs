...
public interface IUserService
{
    ...
    Task<ErrorOr<bool>> ChangeFullNameAsync(string userId, string newFullName);
    Task<ErrorOr<string>> GetPasswordResetToken(string email);
    Task<ErrorOr<bool>> ResetPasswordAsync(string email, string token, string newPassword);
}
