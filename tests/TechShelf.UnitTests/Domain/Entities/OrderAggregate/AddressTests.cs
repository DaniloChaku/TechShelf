...
public class AddressTests
{
    ...
    public void InitializesProperties_WhenValidParametersProvided()
    {
        ...
        // Act
        var address = new Address(name, country, addressLine1, addressLine2, city, region, postalCode);
    ...
    public void ThrowsArgumentException_WhenNameIsInvalid(string? invalidName)
    {
        ...
        // Act
        Action act = () => new Address(invalidName!, country, addressLine1, null, city, region, postalCode);
    ...
    public void ThrowsArgumentException_WhenCountryIsInvalid(string? invalidCountry)
    {
        ...
        // Act
        Action act = () => new Address(name, invalidCountry!, addressLine1, null, city, region, postalCode);
    ...
    public void ThrowsArgumentException_WhenAddressLine1IsInvalid(string? invalidAddressLine1)
    {
        ...
        // Act
        Action act = () => new Address(name, country, invalidAddressLine1!, null, city, region, postalCode);
    ...
    public void ThrowsArgumentException_WhenCityIsInvalid(string? invalidCity)
    {
        ...
        var name = "John";
        var country = ValidCountry;
        var addressLine1 = "New York";
        var region = "NY";
        var postalCode = "10001";

        // Act
        Action act = () => new Address(name, country, addressLine1, null, invalidCity!, region, postalCode);
    ...
    public void ThrowsArgumentException_WhenRegionIsInvalid(string? invalidRegion)
    {
        ...
        // Act
        Action act = () => new Address(name, country, addressLine1, null, city, invalidRegion!, postalCode);
    ...
    public void ThrowsArgumentException_WhenPostalCodeIsInvalid(string? invalidPostalCode)
    {
        ...
        // Act
        Action act = () => new Address(name, country, addressLine1, null, city, region, invalidPostalCode!);
    ...
    {
        // Arrange
        var address1 = new Address("John Doe", ValidCountry, "123 Main Street", "Apt 4B", "New York", "NY", "10001");
        var address2 = new Address("John Doe", ValidCountry, "123 Main Street", "Apt 4B", "New York", "NY", "10001");
    ...
    public void AddressesAreNotEqual_WhenPropertiesDiffer()
    {
        // Arrange
        var address1 = new Address("John Doe", ValidCountry, "123 Main Street", "Apt 4B", "New York", "NY", "10001");
        var address2 = new Address("Jane", ValidCountry, "123 Main Street", "Apt 4B", "New York", "NY", "10001");
